/* ════════════════════════════════════════════════════
   BarberSchedule — script.js  PREMIUM EDITION
   Lógica completa + integração WhatsApp
════════════════════════════════════════════════════ */
...
const state = {
  ...
  servicoAtivo: 'Corte Simples',
  carregando: false,
  pollingTimer: null,
  ultimoAgendamento: null, // guarda dados do último agendamento para o comprovante
};
...
function abrirWhatsApp() {
  ...
  // Gera a mensagem do comprovante
  ...
  // Abre o WhatsApp do próprio usuário sem número fixo —
  // ele escolhe para quem enviar (ex: encaminhar ao dono da barbearia)
...
async function confirmarAgendamento() {
  ...
  try {
    ...
    // Abre comprovante com botão de WhatsApp
...
function bindEventos() {
  ...
  document.addEventListener('keydown', (e) => {
    if (e.key === 'Escape') {
      if (dom.receiptModal.classList.contains('active')) {
        fecharComprovante();
  ...
  dom.receiptModal.addEventListener('click', (e) => {
    if (e.target === dom.receiptModal) fecharComprovante();
  });
}
