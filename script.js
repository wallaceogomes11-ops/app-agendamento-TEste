...
const CONFIG = {
  ...
  /* ─────────────────────────────────────────────────
     CLOUDINARY — Cole aqui as 5 URLs das suas imagens
     após fazer upload no Cloudinary.
     A ordem deve corresponder à ordem dos serviços:
       [0] Corte Simples
       [1] Barba
       [2] Corte + Barba
       [3] Hidratação
  ...
  ───────────────────────────────────────────────── */
  CLOUDINARY_IMAGES: [
    'https://res.cloudinary.com/SEU_CLOUD_NAME/image/upload/w_180,h_180,c_fill,g_face,f_auto,q_auto/NOME_DA_IMAGEM_1.jpg',
    'https://res.cloudinary.com/SEU_CLOUD_NAME/image/upload/w_180,h_180,c_fill,g_face,f_auto,q_auto/NOME_DA_IMAGEM_2.jpg',
    'https://res.cloudinary.com/SEU_CLOUD_NAME/image/upload/w_180,h_180,c_fill,g_face,f_auto,q_auto/NOME_DA_IMAGEM_3.jpg',
    'https://res.cloudinary.com/SEU_CLOUD_NAME/image/upload/w_180,h_180,c_fill,g_face,f_auto,q_auto/NOME_DA_IMAGEM_4.jpg',
    'https://res.cloudinary.com/SEU_CLOUD_NAME/image/upload/w_180,h_180,c_fill,g_face,f_auto,q_auto/NOME_DA_IMAGEM_5.jpg',
  ],
};
...
/* ══════════════════════════════════════════════════
   CLOUDINARY — Aplica URLs nas imagens dos cards
══════════════════════════════════════════════════ */
function aplicarImagensCloudinary() {
  const imgs = document.querySelectorAll('.chip-img-photo[data-cloudinary-index]');
  imgs.forEach(img => {
    const idx = parseInt(img.dataset.cloudinaryIndex, 10);
    const url = CONFIG.CLOUDINARY_IMAGES[idx];
    if (url && !url.includes('SEU_CLOUD_NAME')) {
      img.src = url;
      img.style.display = 'block';
      const fallback = img.nextElementSibling;
      if (fallback) fallback.style.display = 'none';
    } else {
      // URL não configurada: mostra emoji fallback
